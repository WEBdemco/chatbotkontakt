...
initial_greeting = "Marhba bik fi KONTAKT 🥰! Inscrivez-vous dès maintenant pour rejoindre notre grande famille 💛👨‍👩‍👧‍👧<br><a href='https://kontakt.com.tn/web/signup' target='_blank'>kontakt.com.tn.SignUp </a><br> kifech najmou naawnouk ?"
...
product_keywords = ['t-shirts','t-shirt', 'jeans','jean','chemises','chemise','shemise','shemises','blouses','blouse','tops','top','bodies','body','bodie','chemises-blouses',
                    ...
                    'manteaux','manteau','joggers','jogger','polos','polo','swimwear','pyjamas','pyjama','homewear',
                    'accessoires','accessoir','accessoire','underwear','sous-vetement','sous-vetements','sets','set','chaussette','chaussettes','chaussures','chaussure']
# Send message route
